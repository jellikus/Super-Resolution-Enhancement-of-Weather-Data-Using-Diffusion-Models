"""
This code was not utilized in the final thesis but served for experimentation during the Research Summer!!
Idea was to learn physical constraned kernels and these kernels used for diffusion model conditioning.
This code is obtained from https://github.com/vincent-leguen/PhyDNet/blob/master/constrain_moments.py
"""
...
class _MK(nn.Module):
    """
    Base class for moment and kernel conversion.
    It initializes and stores the moment matrices and their inverses.
    """
